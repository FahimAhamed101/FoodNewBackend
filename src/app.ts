...
app.use('/api/v1/provider-onboarding', providerOnboardingRoutes);
...
app.use('/api/v1/admin/feedback', reviewRoutes); // Alias for admin dashboard
...
app.use('/api/v1/admin', adminRestaurantRoutes); // Changed: removed /restaurants
