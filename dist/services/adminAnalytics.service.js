...
class AdminAnalyticsService {
    ...
    getOverviewMetrics(range) {
        return __awaiter(this, void 0, void 0, function* () {
            const [orderStats, customerCount] = yield Promise.all([
     ...
     */
    getTrendAnalytics(filter, range, type) {
        return __awaiter(this, void 0, void 0, function* () {
            let groupBy = {};
            let project = {};
            let sort = { '_id': 1 };
            ...
            const data = yield order_model_1.Order.aggregate([
                {
                    $match: {
                        createdAt: { $gte: range.startDate, $lte: range.endDate },
                        status: filter === 'cancelled' ? order_model_1.OrderStatus.CANCELLED : { $ne: order_model_1.OrderStatus.CANCELLED }
                    }
                },
                {
                    $group: {
     ...
     */
    getTrendingMenus(range) {
        return __awaiter(this, void 0, void 0, function* () {
            const trendingMenus = yield order_model_1.Order.aggregate([
                {
                    $match: {
                        createdAt: { $gte: range.startDate, $lte: range.endDate },
                        status: { $in: [order_model_1.OrderStatus.COMPLETED, order_model_1.OrderStatus.READY_FOR_PICKUP, order_model_1.OrderStatus.PICKED_UP] }
                    }
                },
                { $unwind: '$items' },
                {
     ...
     */
    getTopRestaurants(range) {
        return __awaiter(this, void 0, void 0, function* () {
            const topRestaurants = yield order_model_1.Order.aggregate([
                {
                    $match: {
                        createdAt: { $gte: range.startDate, $lte: range.endDate },
                        status: { $in: [order_model_1.OrderStatus.COMPLETED, order_model_1.OrderStatus.READY_FOR_PICKUP, order_model_1.OrderStatus.PICKED_UP] }
     ...
     */
    getMasterAnalytics(filter, range) {
        return __awaiter(this, void 0, void 0, function* () {
            // Parallel execution to maintain <200ms response time
            const [overview, revenue, ordersOverview, recentOrders] = yield Promise.all([
     ...
     */
    getAnalyticsReports(filter, range) {
        return __awaiter(this, void 0, void 0, function* () {
            const matchQuery = {
                createdAt: { $gte: range.startDate, $lte: range.endDate },
                status: { $ne: order_model_1.OrderStatus.CANCELLED }
            };
            const [revenueTrend, volumeTrend, stateAnalysis, customerAnalysis] = yield Promise.all([
    ...
    getReportTrend(filter, range, type) {
        return __awaiter(this, void 0, void 0, function* () {
            let groupBy = {};
            let project = {};
            let labels = [];
            ...
            switch (filter) {
                case 'today':
                    ...
                    initialValues = labels.reduce((acc, label) => (Object.assign(Object.assign({}, acc), { [label]: 0 })), {});
                    break;
                case 'week':
                ...
                case 'year':
                    ...
                    labels = months;
                    initialValues = months.reduce((acc, label) => (Object.assign(Object.assign({}, acc), { [label]: 0 })), {});
                    break;
                case 'custom':
            ...
            const result = Object.assign({}, initialValues);
            data.forEach(item => {
                let key = item._id;
                if (filter === 'week') {
                    const weekDays = ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'];
    ...
    getCustomerAnalysis(range) {
        return __awaiter(this, void 0, void 0, function* () {
            const activeCustomers = yield order_model_1.Order.distinct('customerId', {
                createdAt: { $gte: range.startDate, $lte: range.endDate },
                status: { $ne: order_model_1.OrderStatus.CANCELLED }
            });
            return {
...
exports.default = new AdminAnalyticsService();
